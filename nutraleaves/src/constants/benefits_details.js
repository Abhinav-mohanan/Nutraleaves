export const benefits_details = {
  Chemoprevention: {
    definition:
      "Chemoprevention is the use of natural, synthetic, or biological agents to reverse, suppress, or prevent the development of cancer.",
    mechanism:
