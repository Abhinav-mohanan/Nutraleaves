...
const Header = () => {
  return (
    <header className='sticky top-0 z-50 w-full border-b border-emerald-200 dark:border-emerald-900/30 bg-stone-50/90 
    dark:bg-pearl-900 backdrop-blur-md px-4 lg:px-40 py-3'>
        <div className='flex items-center justify-between max-w-[1200px] mx-auto'>
            <div className='flex items-center text-slate-900 dark:text-emerald-400'>
                <div className='size-8 text-emerald-500'>
                    <LeafIcon className='w-6 h-6 mt-1'/>
                </div>
                <h2 className='text-xl font-black leading-tight tracking-tight dark:text-black'>Nutraleaves</h2>
            </div>
