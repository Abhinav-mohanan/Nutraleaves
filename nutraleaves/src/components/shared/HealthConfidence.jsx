            ...
            <div className="relative">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <p className="text-slate-600 text-base leading-relaxed">
                        Microgreens are young seedlings of vegetables, herbs, cereals, and legumes, consist of developed cotyledons along with
partially expanded true leaves, that are approximately 1–3 inches (2.5–7.5 cm) tall, these immature plants are harvested
between 7-21 days (depending on variety), they have an aromatic flavour, concentrated nutrient content and come in a
variety of colours and textures. They are excellent source of vitamins, minerals, and polyphenols often containing higher than normal nutrient levels than their mature counterparts. They are suitable for eating raw, juiced, or blended, They are considered the next generation of superfoods and can support overall health from boosting immunity to reducing inflammation.
                        By harvesting our microgreens at the peak of their nutritional potency, we ensure a concentration of vitamins C and E that is significantly higher than mature plants, creating a potent synergy for anti-ageing.
                    </p>
                    </div>
